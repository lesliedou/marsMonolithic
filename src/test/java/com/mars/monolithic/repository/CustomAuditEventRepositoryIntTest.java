package com.mars.monolithic.repository;

import com.mars.monolithic.MarsMonolithicApp;
import com.mars.monolithic.config.Constants;
import com.mars.monolithic.config.audit.AuditEventConverter;
import com.mars.monolithic.domain.PersistentAuditEvent;
...
import static com.mars.monolithic.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
